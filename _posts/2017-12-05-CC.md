...
Define T_atomic is the runtime of CC in Groute framework. 
...
Because t_ato + t_merg takes more than 90% of T_atomic, and the computation on each GPU is well overlapped, we use T_atomic to reflex the influence of atomic operation on runtime
